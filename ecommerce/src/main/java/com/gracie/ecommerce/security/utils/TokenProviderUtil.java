...
//    String generateLoginToken(Authentication authentication);
    ...
    String getEmailFromBearerToken(String userUniqueToken);

    String getUserUniqueIdFromBearerToken(String userUniqueToken);
}
